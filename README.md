...
1. Prerequisites
    ...
    11. [Graphical Representations of Probability](01_prereqs/11_graph_prob.qmd)
    12. [Independence](01_prereqs/12_independence.qmd)
    13. [Expected Value](01_prereqs/13_expected_value.qmd)
    14. [Population and Sample](01_prereqs/14_population_sample.qmd)
    15. [Sample Average](01_prereqs/15_sample_average.qmd)
    16. [Parameter and Statistic](01_prereqs/16_parameter_statistic.qmd)
    17. [Tilde](01_prereqs/17_tilde.qmd)
    18. [Estimator and Estimand](01_prereqs/18_estimator_estimand.qmd)
    19. [Variance](01_prereqs/19_variance.qmd)
    20. [Bias](01_prereqs/20_bias.qmd)
    21. [Accuracy and Precision](01_prereqs/21_accuracy_precision.qmd)
    22. [Hypothesis Test](01_prereqs/22_hypothesis_test.qmd)
    23. [Marginal and Conditional Distributions](01_prereqs/23_marginal_conditional.qmd)
    24. [Conditional Expectation](01_prereqs/24_conditional_expectation.qmd)
